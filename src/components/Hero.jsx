...
const Hero = () => {
  return (
    <>
      ...
      <section id="home" className="pt-48 flex justify-center">
        <div
          // className="container lg:grid lg:grid-cols-1 items-center lg:gap-10"
        ...
        >
          <div>
            ...
            <h2 className="headline-1 max-w-[15ch] sm:max-w-[20ch] lg:max-w-[20ch] mt-5 mb-20 lg:mb-12 flex flex-col">
              <div className="flex flex-row justify-center items-baseline"><span className="text-3xl md:text-4xl lg:text-5xl mr-3 text-zinc-400">Enabling</span><span className="text-4xl md:text-5xl lg:text-6xl ">Innovations</span></div>
              <div className="flex flex-row items-baseline"><span className="text-4xl md:text-5xl lg:text-6xl mr-3 text-zinc-400">Empowering</span><span className="text-5xl md:text-6xl lg:text-7xl">Growth</span></div>
              <br />
            ...
            <div className="flex items-center justify-between px-8 lg:px-32 pt-64 md:pt-40">
              <ButtonPrimary
                href="#services"
              ...
              />
              <ButtonOutline
                href="https://drive.google.com/file/d/1Qlqjpdje6TLcBOVH57EUGaQn7rLgr0BK/view?usp=drive_link"
                icon="Download"
                label="Quotation"
            ...
            <div className="flex items-center justify-center gap-4 mt-auto pt-5 hidden md:flex">
            <a 
                href="#about" 
                className="logo reveal-up flex flex-col items-center">
                    <img 
                    ...
                    alt="Logo" 
                    className="mb-2" />
                    <span className="text-zinc-400 text-xs">Scroll Down</span>
                </a>
